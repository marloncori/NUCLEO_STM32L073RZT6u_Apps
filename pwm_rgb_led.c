...
{
   uint32_t i; 
   uint32_t duty_cycles[12] = {5_PCT, 7_5_PCT, 10_PCT, 20_PCT, 
   30_PCT, 40_PCT, 50_PCT, 60_PCT, 70_PCT, 80_PCT, 90_PCT, 100_PCT,};
   ...
   {
       for(i=0; i<12; i++){
         TIM->CCR1 = duty_cycles[i];
         TIM->CCR2 = duty_cycles[i];
         TIM->CCR3 = duty_cycles[i];
         HAL_Delay(500);
       }
   }
}
